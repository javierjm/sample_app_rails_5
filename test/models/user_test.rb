...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation shoudl accept valid addressses" do 
    valid_addresses = %w[user@example.com USER@foo.COM A_US-ERR@foo.bar.org first.last@foo.jp alice+bob@baz.cn]
